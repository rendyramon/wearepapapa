 ...
 * <li>{@link com.leyue100.leyi.tools.ViewUtils#getListViewHeightBasedOnChildren(ListView)}</li>
 * <li>{@link com.leyue100.leyi.tools.ViewUtils#getAbsListViewHeightBasedOnChildren(AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>set view height</strong>
 * <li>{@link com.leyue100.leyi.tools.ViewUtils#setViewHeight(View, int)} set view height</li>
 * <li>{@link com.leyue100.leyi.tools.ViewUtils#setListViewHeightBasedOnChildren(ListView)}</li>
 * <li>{@link com.leyue100.leyi.tools.ViewUtils#setAbsListViewHeightBasedOnChildren(AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>get other info</strong>
 * <li>{@link com.leyue100.leyi.tools.ViewUtils#getGridViewVerticalSpacing(GridView)} get GridView vertical spacing</li>
 * </ul>
 * <ul>
 * <strong>set other info</strong>
 * <li>{@link com.leyue100.leyi.tools.ViewUtils#setSearchViewOnClickListener(View, OnClickListener)}</li>
 * </ul>
 *
