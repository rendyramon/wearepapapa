...
public class JSONUtils {
     ...
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getLong(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see com.leyue100.leyi.tools.JSONUtils#getLong(JSONObject, String, Long)
     */
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see com.leyue100.leyi.tools.JSONUtils#getLong(String, String, Long)
     */
    public static long getLong(String jsonData, String key, long defaultValue) {
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getInt(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see com.leyue100.leyi.tools.JSONUtils#getInt(JSONObject, String, Integer)
     */
     ...
     * @param defaultValue
     * @return
     * @see com.leyue100.leyi.tools.JSONUtils#getInt(String, String, Integer)
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getDouble(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see com.leyue100.leyi.tools.JSONUtils#getDouble(JSONObject, String, Double)
     */
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see com.leyue100.leyi.tools.JSONUtils#getDouble(String, String, Double)
     */
    public static double getDouble(String jsonData, String key, double defaultValue) {
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getString(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getStringArray(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getStringList(JSONObject, String, List)}</li>
     * </ul>
     */
     ...
     * <li>if jsonData is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getJSONObject(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getJSONArray(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getBoolean(JSONObject, String, Boolean)}</li>
     * </ul>
     */
     ...
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#parseKeyAndValueToMap(String)}</li>
     * </ul>
     */
     ...
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#getMap(JSONObject, String)}</li>
     * </ul>
     */
     ...
     * <li>return {@link com.leyue100.leyi.tools.JSONUtils#parseKeyAndValueToMap(JSONObject)}</li>
     * </ul>
     */
